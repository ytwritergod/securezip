...
async def start_zip_session(_, message: Message):
    ...
    await message.reply(f"🔄 Send files (Total ≤ {format_size(MAX_TOTAL_SIZE)}")

# ==================== FILE HANDLING ====================
@app.on_message((filters.document | filters.video | filters.photo) & authorized)
